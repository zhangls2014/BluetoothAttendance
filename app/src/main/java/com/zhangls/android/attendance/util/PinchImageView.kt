...
class PinchImageView : ImageView {
    ...
    private fun initView() {
        // 强制设置图片 scaleType 为 matrix
        super.setScaleType(ImageView.ScaleType.MATRIX)
    }

    // 不允许设置 scaleType，只能用内部设置的 matrix
    ...
    object MathUtils {
         ...
         */
        fun calculateScaledRectInContainer(container: RectF?, srcWidth: Float, srcHeight: Float, scaleType: ImageView.ScaleType?, result: RectF?) {
